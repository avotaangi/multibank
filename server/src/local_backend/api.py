...
def seed_state() -> Dict[str, Any]:
    ...
    return {
        ...
        "banks": {
            "vbank": {"id": "vbank", "name": "VBank", "url": "http://localhost:8000/local/vbank"},
            "abank": {"id": "abank", "name": "ABank", "url": "http://localhost:8000/local/abank"},
            "sbank": {"id": "sbank", "name": "SBank", "url": "http://localhost:8000/local/sbank"},
        },
...
async def create_account(payload: Dict[str, Any]) -> Dict[str, Any]:
    new_account = {
        ...
        "bankName": payload.get("bankName", "VBank"),
