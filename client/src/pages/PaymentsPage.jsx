...
import { ArrowLeft, CreditCard, CheckCircle, XCircle, Clock, Download, Search, Phone, Info } from 'lucide-react';
...
const PaymentsPage = () => {
  ...
  const popularServices = [
    { id: '1', name: 'КИВИ', description: 'Пополнение кошелька QIWI', icon: '💳' },
